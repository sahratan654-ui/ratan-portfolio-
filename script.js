...
/* =========================================
   RATAN PRAKASH SAH - TYPING LOOP
========================================= */

const animatedName = document.querySelector(".animated-name");
const whiteName = document.querySelector(".name-white");
const greenName = document.querySelector(".name-green");

const firstName = "Ratan";
const lastName = "Prakash Sah.";
...
function animateName() {
    ...
    if (currentText.length <= firstName.length) {

        whiteName.textContent =
            currentText;

        greenName.textContent = "";
        ...
        greenName.textContent =
            currentText.substring(firstName.length);
    }

    if (!deleting && currentText === fullName) {
